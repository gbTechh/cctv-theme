        ...
        6506: (t, e, s) => {
            ...
            const v = new class {
                ...
                init(t) {
                    ...
                    this.pixelRatio = Math.min(1.8, window.devicePixelRatio), this.$canvas = e, this.renderer = new d.C({
                        antialias: !0,
                        alpha: !0,
                        canvas: this.$canvas,
                        preserveDrawingBuffer: !0
                    }), this.renderer.autoClearColor = !1, this.renderer.sortObjects = !0, this.renderer.setPixelRatio(this.pixelRatio), this.clock = new p.S, this.clock.start(), this.resize()
                }
                resize() {
            ...
            const g = new class {
                constructor() {
                    this.aurora = {
                        ...
                        color2: new f.I(1),
                        color3: new f.I(0),
                        color4: new f.I(154855545454884)
                    }, this.params = {
                        noiseIntensity: new m.F(1, .5),
                        noiseScale: new m.F(1, .48),
                        opacity: 1
                    }
                }
                init() { }
            ...
            const R = new class {
                ...
                init() {
                    ...
                    }, this.plane_aurora = new x.K(new _._(2, 2), new b.j({
                        vertexShader: T,
                    ...
                    })), this.plane_output = new x.K(new _._(2, 2), new b.j({
                        vertexShader: T,
            ...
            const q = new class {
                ...
                setVideos(t, e) {
                    const s = document.body.querySelectorAll(e);
                    for (let e = 0; e < s.length; e++) this.videos[t + "_" + e] = {
                        $video: s[e],
                        value: null
                    }
                }
                    ...
                    fetch(`${ruta_obj.ruta}/assets/img/dev/media.json`, {
                        ...
                        for (let t in this.cmsDatas) {
                            ...
                            for (let s = 0; s < e.length; s++)
                                for (let i in e[s]) "image" == i ? this.textures[t + "_" + s] = {
                                    src: e[s][i]
            ...
            const H = new class {
                ...
                init() {
                    ...
                    }, this.plane = new x.K(new _._(2, 2), new b.j({
                        vertexShader: T,
            ...
            const Y = new class {
                ...
                init() {
                    ...
                    this.fbos = [new y.d(v.dimensions.x, v.dimensions.y, e), new y.d(v.dimensions.x, v.dimensions.y, e)], this.fbo = this.fbos[1], this.uniforms.uOldMap.value = this.fbos[0], c.on("UPDATE_SCROLL", (t => {
                        let {
                            detail: e
                        } = t;
            ...
            class Z extends $ {
                constructor() {
                    ...
                    }), this.group2 = new G.Z, this.group.add(this.group2), this.lookAtTarget = new B.P, this.zInterval = 60, this.defPosition = this.getPosition(new B.P, 4), this.defPosition.y *= .5, this.videoGroupArray = [], this.oldNum = 0, this.videoMngs = [], this.focusNum = 0, this.scrollY = 0, this.stepNum = 5, this.targetPosition = {
                        start: this.getPosition(new B.P, -2),
                        end: this.getPosition(new B.P, 3)
                    }, c.on("UPDATE_SCROLL", (t => {
                        let {
                            detail: e
                        } = t;
                        E("isIndex") && (this.scrollY = e.offset.y, e.offset.y > v.dimensions.y / 2 ? (this.hide(), this.hideVideos()) : (this.show(), this.showVideos()))
                ...
                updateLowBattery() {
                    for (let t = 0; t < this.videoMngs.length; t++) this.videoMngs[t].$video.play(), this.videoMngs[t].isPlaying || setTimeout((() => {
                ...
                createLoopText() {
                    ...
                    this.uniforms_text = {
                    ...
                    }, this.loopText = new x.K(new _._(4, 1 / e), new b.j({
                        vertexShader: W,
                        ...
                        depthTest: !1,
                        depthWrite: !1
                    })), this.loopTextHide = new B.P(0, 0, this.defPosition.z), this.loopTextShow = new B.P(0, -100, this.defPosition.z), this.loopText.renderOrder = -1, this.loopText.position.copy(this.loopTextHide), this.group.add(this.loopText)
                }
                createVideoMeshes() {
                    let t = 9 / 16;
                    this.uniforms = {
                    ...
                    for (let t = 0; t < this.videoNum; t++) {
                        ...
                        this.videoMngs[t] = new K(q.videos[this.sectionName + "_" + t], t, s), this.videoMngs[t].play(), setTimeout((() => {
                            this.videoMngs[t].pause(!0), 2 !== t && (this.videoMngs[t].isPlaying = !0)
                        }), 0), s.userData._totalNum = s.userData.totalNum = t + 2;
                        let i = s.userData.totalNum / this.stepNum;
                        s.userData.totalProgress = i - Math.floor(i), s.userData.currentPos = new B.P, s.userData.totalPos = new B.P;
                        const n = {
                            ...this.uniforms,
                            uTex: {
                ...
                update() {
                    if (this.uniforms) {
                        ...
                        this.group.position.y = s, this.uniforms.uOffsetY.value = this.group.position.y, this.group.rotation.x = v.isMobile2 ? -.1 : 0, v.isMobile || (this.lookAtTarget.set(.1 * Y.currentPos2.x, .1 * Y.currentPos2.y + s, 1), this.group2.lookAt(this.lookAtTarget)), this.loopText.position.lerpVectors(this.loopTextHide, this.loopTextShow, this.progress.position.c), this.loopText.position.y += v.isMobile2 ? .1 * v.dimensions.x : 0;
            ...
            class Q extends $ {
                ...
                init() {
                    ...
                    }, this.mesh_0 = new x.K(new _._(1, 1 / e), new b.j({
                        vertexShader: W,
                        fragmentShader: J,
                        uniforms: this.uniforms,
                        depthTest: !1,
                    ...
                    this.mesh_1 = new x.K(new _._(1, 1 / i), new b.j({
                        vertexShader: W,
                        fragmentShader: J,
                        uniforms: this.uniforms,
                        depthTest: !1,
                        depthWrite: !1,
                        transparent: !0
                    })), this.mesh_0.renderOrder = -1, this.mesh_1.renderOrder = -1, this.group.add(this.mesh_0), this.group.add(this.mesh_1)
                }
                checkPosition() {
            ...
            class st extends $ {
                constructor() {
                    super({
                        ...
                        }), this.slider.isEnableFocus && (this.slider.isActive = !1, this.slider.isFocus = !0, this.slider.focus.t = 1, L("aboutVideos.isFocus", !0))
                    })), c.on("UNFOCUS_ABOUT_VIDEO", (() => {
                        this.slider.isFocus && !this.slider.focus_next.isSwitching && (c.emit("RETURN_FOCUS_ABOUT_VIDEO", {
                            isFocus: !1
                        }), this.slider.isActive = !0, this.slider.isFocus = !1, this.slider.focus.t = 0, L("aboutVideos.isFocus", !1))
                ...
                init() {
                    ...
                    }, this.videoNum = q.cmsDatas.aboutVideos.length, this.videoMngs = [];
                    for (let t = 0; t < this.videoNum; t++) {
                        const e = q.videos[this.sectionName + "_" + t];
                        this.videoMngs[t] = new et(e, t)
                    }
                    this.offsetY = -300;
                    this.videoMngs[0].play(), setTimeout((() => {
                        this.videoMngs[0].pause()
                    }), 10), this.commonUniforms = {
                        uOpacity: {
                    ...
                    this.mesh = new x.K(t, e), this.mesh.renderOrder = 1, this.group.add(this.mesh), this.mirrorCamera = new F.c(45, v.dimensions.x / v.dimensions.y, .1, 1e5), this.mirrorCamera.up.set(0, -1, 0), this.mirrorTarget = new B.P, this.mirrorScale = new tt.y, this.mirrorScale.makeScale(-1, 1, 1), this.mirrorPM = new tt.y, this.mirrorMesh = new x.K(t, new b.j({
                        vertexShader: W,
                ...
                init(t, e, s, i) {
                    ...
                    for (let n = 0; n < 2; n++) {
                        const o = new G.Z,
                            ...
                            h = {
                                num: n,
                                index_start: new B.P(2 * (n - .5), n + 1, -(n + 1)),
                                offsetY: 0,
                                pos_start: new B.P,
                                rot_start: new nt.U,
                                quat_start: new ot._,
                        ...
                        const u = new b.j({
                            ...
                            m = new x.K(e, u);
                        m.frustumCulled = !1, this.meshes[n] = {
                            mesh_front: c,
                            mesh_back: m,
                            uniforms: a,
                            userData: h,
                            group: o
                        }, o.add(m), o.add(c), this.group.add(o)
                    }
                }
                update(t) {
                    this.radius = t;
                    ...
                    for (let t = 0; t < this.meshes.length; t++) {
                        ...
                        o.offsetY -= 1200 * v.delta, s.position.x = (o.index_start.x + Math.cos(2 * this.commonUniforms.uTime.value - t * Math.PI)) * e * .5, s.position.y = o.index_start.y * e + o.offsetY, s.position.z = -o.index_start.z * e;
                        let a = 2 * (t - .5);
                        o.rot_start.z = .2 * a * Math.PI, o.rot_start.x = 2 * a * Math.PI - .2 * Math.cos(4 * this.commonUniforms.uTime.value), o.rot_start.y = .1 * a * Math.PI, o.quat_start.setFromEuler(o.rot_start), s.quaternion.copy(o.quat_start), s.scale.set(e, e, e), s.updateMatrix()
                    }
                }
            }
            class mt {
                constructor(t) {
                    ...
                    })), this.group = new G.Z, c.on("UPDATE_SCROLL", (t => {
                        let {
                            detail: e
                        } = t;
                        this.checkPosition()
                ...
                init() {
                    ...
                    this.uniforms = {
                    ...
                    }, this.mesh = new x.K(new _._(4, 1 / e), new b.j({
                        vertexShader: W,
                        ...
                        depthTest: !1,
                        depthWrite: !1
                    })), this.mesh.visible = !1, this.mesh.renderOrder = -1, this.group.add(this.mesh)
                }
                getTargetElement() {
            ...
            class dt extends $ {
                constructor(t) {
                    super({
                        ...
                        sectionName: "ourWork"
                    }), this.raycaster = new it.i, this.raycastMeshes = [], this.meshes = [], this.clickFocus = {
                        status: !1,
                        num: null,
                        progress: 0,
                        enableClose: !1
                    }, this.showTimeOnce = 0, this.isStarted = !1, this.scrollOffsetY = 0, this.hover = {
                        isHover: !1,
                        currentNum: null,
                        lookAt: new B.P,
                        progress: 0
                    }, this.yScale = .17, this.scroll = {
                        offsetY: 0,
                        _offsetY: 0,
                        rotationY: 0,
                        _rotationY: 0,
                        isStart: !1,
                        progress: 0
                    }, this.group.visible = !0, this.singleFrontPoster = new ut, this.workLoopText = new mt(t), this.group.add(this.singleFrontPoster.group), setTimeout((() => {
                        this.group.visible = !1
                    }), 100), c.on("UPDATE_SCROLL", (t => {
                        let {
                            detail: e
                        } = t;
                ...
                init(t) {
                    ...
                    for (let t = 0; t < this.imageNum; t++) {
                        const e = new G.Z,
                            s = {
                                num: t,
                                index_start: new B.P(t % 3 - 1, t / 5 + 4, t % 5 - .7),
                                pos_start: new B.P,
                                rot_start: new nt.U,
                                quat_start: new ot._,
                                pos_end: new B.P,
                        ...
                        const u = new x.K(n, c);
                        u.frustumCulled = !1, this.meshes[t] = {
                            mesh_front: l,
                            mesh_back: u,
                            uniforms: a,
                            userData: s,
                            animation: o,
                            group: e
                        }, e.add(u), e.add(l), this.group.add(e)
                    }
                    ...
                    if (this.scroll.isStart) {
                        ...
                        if (e.length > 0) {
                            ...
                            this.updateHover(), this.clickFocus.status = !0, this.clickFocus.num = s, t.isClick = !0, t.num = s, c.emit("ENABLE_CLOSE_WORK_CARD", {
                                enable: !1
                            }), this.scrollClickFocusMesh(), setTimeout((() => {
                ...
                scrollClickFocusMesh() {
                    if (this.clickMesh && this.clickFocus.status) {
                        const t = this.clickMesh.userData.num,
                            e = (this.imageNum - t - 1) / (this.imageNum - 1) * (this.targetData.height - v.dimensions.y) + this.targetData.top + this.scrollY;
                ...
                resize() {
                    if (this.commonUniforms) {
                        ...
                        const t = new tt.y,
                            e = .8 * this.radius,
                            s = new rt.L(this.aspect * e, e, .15 * e, 1);
                        t.setPosition(0, 0, -this.radius), s.applyMatrix4(t), s.applyMatrix4(this.camera.matrixWorldInverse), s.applyMatrix4(this.camera.projectionMatrix), s.multiplyScalar(1 / s.w), this.$target.style.height = 6 * v.dimensions.x + "px", c.emit("GET_WORK_CARD_SIZE", {
                            width: .5 * v.dimensions.x * s.x,
                            height: .5 * v.dimensions.y * s.y
                        ...
                        if (this.clickFocus.status);
                            ...
                            if (t.length > 0) {
                                ...
                                this.hover.isHover && this.hover.currentNum === e || (null !== this.hover.currentNum && (this.meshes[this.hover.currentNum].userData.isHover = !1), s.isHover = !0, c.emit("HOVER_WORK_CARD", {
                                    isHover: !0,
                                    num: e
                                })), s.hoverUV.x = t[0].uv.x, s.hoverUV.y = t[0].uv.y, this.hover.currentNum = e, this.hover.isHover = !0
                ...
                releaseHover() {
                    this.hover.isHover && (this.meshes[this.hover.currentNum].userData.isHover = !1, c.emit("HOVER_WORK_CARD", {
                        isHover: !1
                    })), this.hover.isHover = !1, this.hover.currentNum = null
                }
                update() {
                    ...
                    this.radius = v.dimensions.x, this.radiusAspect = v.isMobile ? .8 : .6, this.radius *= this.radiusAspect;
                    let t = .8 * this.radius;
                    ...
                    for (let e = 0; e < this.meshes.length; e++) {
                        ...
                        this.updateAnimation(r, e, o), a.uProgress.value.x = r.fall.c, a.uProgress.value.y = r.roll.c, o.pos_start.set((o.index_start.x + Math.cos(this.commonUniforms.uTime.value + 100 * o.random.x)) * t * 1.5, o.index_start.y * t - r.fall.c * t * 8, -o.index_start.z * t), o.rot_start.z = .4 * Math.cos(2 * o.random.y * Math.PI), o.rot_start.x = .5 * Math.cos(2 * o.random.z * Math.PI), o.rot_start.y = .3 * Math.cos(2 * o.random.x * Math.PI), o.quat_start.setFromEuler(o.rot_start);
                        let h = o.radian;
                        o.pos_end.set(Math.sin(h) * this.radius, (e - (this.meshes.length - 1) / 2) * t * this.yScale - t * this.yScale * ((this.meshes.length - 1) / 2) - (1 - r.roll.c) * v.dimensions.x * 2, Math.cos(h) * this.radius), o.rot_end.set(0, h, 0), o.quat_end.setFromEuler(o.rot_end), this.changePosition(s, o, r)
                    }
                    if (this.isStarted) {
                        ...
                        this.updateAnimation(this.wholeAnim), this.group.position.z = 1.5 * -this.radius * this.wholeAnim.fall.c, this.group.position.y = A(0, this.scroll.offsetY, this.scroll.progress), this.group.rotation.y = A(0, this.scroll.rotationY, this.scroll.progress), this.singleFrontPoster.update(this.radius)
                    }
                ...
                _buildConfig() {
                    for (var t = 0; t < this.items.length; t++) {
                        const e = this.items[t],
                            s = {
                                el: e,
                                tgt: e.querySelectorAll(".js-scfx-t"),
                                pad: 0,
                                pos: {
                                    s: 0,
                                    e: 0
                ...
                _buildConfig() {
                    for (var t = 0; t < this.items.length; t++) {
                        const e = this.items[t],
                            s = {
                                el: e,
                                tgt: e.querySelectorAll(".js-scspd-t"),
                                pad: 0,
                                pos: {
                                    s: 0,
                                    e: 0
                ...
                gt = {
                    ...
                    scroll: function (t) {
                        ...
                        this.scrollY = e.y, a.scroll.pos = this.scrollY, "home" === a.dir && c.emit("UPDATE_SCROLL", {
                            offset: e
                        }), e.y > 100 ? h.documentElement.classList.add("is-scrolled") : h.documentElement.classList.remove("is-scrolled"), this.FIX._update(), this.SPEED._update(), h.documentElement.classList.add("is-scrolling"), clearTimeout(this.timer), this.timer = setTimeout((function () {
                ...
                wt = new class {
                    constructor() {
                        this.item = {}, this.anim = {
                            ...
                            x: 0,
                            y: 0
                        }], this.onHit = this._hit.bind(this), this.onKey = this._key.bind(this), this.onMouseEnter = this._mouseEnter.bind(this), this.onMouseMove = this._mouseMove.bind(this), this.onMouseLeave = this._mouseLeave.bind(this)
                    }
                    init() {
                        this.item = {
                    ...
                    once() {
                        ...
                        this.item.hit.addEventListener("click", this.onHit, !1), h.addEventListener("keydown", this.onKey, !1), "click" === a.evt && (this.item.hit.addEventListener("mouseenter", this.onMouseEnter, !1), this.item.hit.addEventListener("mousemove", this.onMouseMove, !1), this.item.hit.addEventListener("mouseleave", this.onMouseLeave, !1))
                    }
                    _mouseEnter(t) {
                        const e = this,
            ...
            const xt = class {
                constructor(t) {
                    ...
                    }, this.onMe = this.me.bind(this), this.init()
                }
                init() {
            ...
            const Tt = class {
                constructor(t) {
                    ...
                    this.POS = {
                        ...
                        delay: .05,
                        ease: "Power1.inOut"
                    }, this.onMe = this.me.bind(this), this.onMl = this.ml.bind(this), this.onUpdate = this._update.bind(this), this.init()
                }
                init() {
                    const t = this;
            ...
            const Lt = class {
                ...
                At = {
                    ...
                    init: function () {
                        this.item = {
                            hv: a.new.querySelectorAll(".js-hv"),
                            hvo: h.body.querySelectorAll(".js-hvo")
            ...
            const kt = class {
                constructor(t) {
                    this.el = t, this.TGT = this.el.getAttribute("data-tgt") ? h.getElementById(this.el.getAttribute("data-tgt")) : null, this.SITEPARTS = h.body.querySelectorAll(".-siteparts"), this.items = {}, this.conf = {
                        ...
                        speed: .8,
                        ease: "Power2.inOut"
                    }, this.onHit = this._hit.bind(this), this.onClose = this._close.bind(this), this.onBtn = this._btn.bind(this), this.onFocusCheck = this._focusCheck.bind(this), this.init()
                }
                init() {
                    if (null !== this.TGT) {
                        this.items = {
                            close: this.TGT.querySelectorAll(".-close"),
                            btn: this.TGT.querySelectorAll(".-btn")
                        }, this.el.addEventListener("click", this.onHit, !1);
                        for (var t = 0; t < this.items.close.length; t++) this.items.close[t].addEventListener("click", this.onClose, !1);
                ...
                _kill() {
                    ...
                    for (var t = 0; t < this.items.close.length; t++) this.items.close[t].removeEventListener("click", this.onClose, !1);
                    for (t = 0; t < this.items.btn.length; t++) this.items.btn[t].removeEventListener("click", this.onBtn, !1);
                    this._partsShow()
                }
            },
                Pt = {
                    ...
                    init: function () {
                        this.item = {
                            hit: a.new.querySelectorAll(".js-hit"),
                            hito: h.body.querySelectorAll(".js-hito")
                        }, this.kill(), this.once()
                    },
                    once: function () {
                ...
                Ft = new class {
                    ...
                    init() {
                        ...
                        }, this.FINISH_LOADING = t._onComplete.bind(this), this.onGetSize = t._getSize.bind(this), this.onMouseMove = t._mouseMove.bind(this), this.onLoadComp = t._loadcomp.bind(this), this.item.wp.addEventListener("mousemove", this.onMouseMove, !1), window.addEventListener("resize", this.onGetSize, !1);
                        h.body.querySelectorAll("form").length <= 0 && "entry" !== h.getElementById("js-ct").getAttribute("data-pj-dir") ? (this.once(), c.on("FINISH_LOADING", this.FINISH_LOADING)) : this._hideCount(), c.on("COUNT_LOADING", (e => {
                            let {
                                detail: s
                            } = e;
                    ...
                    once() {
                        r.to(this.item.prog, {
                            duration: this.anim.showCount.speed,
                            opacity: 1,
                            ease: this.anim.showCount.ease
                        })
                    }
                    _updateCount(t) {
            ...
            const zt = class {
                constructor(t) {
                    this.el = t, this.ISCHANGE = !1, this.PROG = 0, this.PROGFAKE = {
                        ...
                        ease: o.t.create("BTN", "M0,0 C0.404,0.098 0.162,1 1,1"),
                        min: "power1.out"
                    }, this.onHit = this._hit.bind(this), this.onUpdateNumber = this._updateNumber.bind(this), this.onUpdateProgress = this._updateProgress.bind(this), this.init()
                }
                init() {
                    this._attach()
                }
                ...
                _updateNumber(t) {
                    ...
                    const s = this;
                    !1 === this.ISCHANGE && (this.ISCHANGE = !0, this.PROGFAKE = {
                        v: 100 * s.PROG - 100
                    }, r.killTweensOf(this.PROGFAKE), r.to(s.PROGFAKE, {
                ...
                jt = class {
                    ...
                    _load(t, e) {
                        for (var s = 0; s < t.length; s++) t[s].isIntersecting && !t[s].target.classList.contains("-l") && (t[s].target.classList.add("-l"), this._imgLoading())
                    }
                    _imgLoading() {
            ...
            const Gt = class {
                constructor(t) {
                    ...
                    }), this.SLIDES = [], this._TIMER_ = {
                        v: 0
                    }, this.config = {
                        all: 0,
                        from: 0,
                        to: 0
                    }, this.OPENINGPATH = [], this.item = {
                        one: t.querySelectorAll(".js-jus-one"),
                        item: t.querySelectorAll(".js-jus-item")
                    }, this.anim = {
                        timer: 3,
                        speed: 1,
                        path: .04,
                ...
                _default(t, e) {
                    const s = this;
                    for (var i = 0; i < t.length; i++) t[i].isIntersecting ? (!1 === s.IV && (s.IV = !0, s._opening()), this.TML.play()) : this.TML.pause()
                }
                _onNext_() {
                ...
                _engine() {
                    ...
                    for (var e = 0; e < this.SLIDES.length; e++) {
                        const i = this.SLIDES[e],
                            n = e,
                            o = {
                                item: i.items[this.config.from],
                                paths: i.paths[this.config.from]
                            },
                            a = {
                        ...
                        for (var s = 0; s < o.paths.length; s++) r.to(o.paths[s], {
                        ...
                        for (s = 0; s < a.in.length; s++) {
                            r.fromTo(a.in[s], {
                                ...
                                duration: t.anim.scale.speed,
                                scale: 1,
                                delay: t.anim.delay * s,
                                ease: t.anim.scale.ease
                            })
                        }
                    }
                }
            ...
            const Ht = class {
                constructor(t) {
                    ...
                    }, this.onChange = this._change.bind(this), this.onF = this._f.bind(this), this.init()
                }
                init() {
                ...
                _f() {
                    const t = this;
                    for (var e = 0; e < this.item.input.length; e++) this._change({
                        target: t.item.input[e],
                        currentTarget: t.item.input[e]
                    })
                }
                _attach() {
                    const t = this;
                ...
                _labelUpdate(t) {
                    ...
                    for (var s = 0; s < this.item.label.length; s++) this.item.label[s].classList.remove("_err"), this.item.label[s].classList[e]("_hasitem"), this.item.label[s].innerHTML = t
                }
                _labelError() {
                    for (var t = 0; t < this.item.label.length; t++) this.item.label[t].classList.add("_err"), this.item.label[t].innerHTML = "ファイルの最大サイズは15MBです"
                }
                _kill() {
                    for (var t = 0; t < this.item.input.length; t++) this.item.input[t].removeEventListener("change", this.onChange);
                    return null
                }
            },
                Yt = {
                ...
                Wt = class {
                    constructor(t) {
                        this.el = t, this.SUBMIT = !1, this.items = {
                            ...
                            speed: .4,
                            ease: "power2.inOut"
                        }, this.completeList = {}, this.onChange = this._change.bind(this), this.onBlur = this._blur.bind(this), this.onInput = this._input.bind(this), this.onCheck = this._check.bind(this), this.onReCheck = this._recheck.bind(this), this._disable(), this._addevents(), setTimeout(this.onReCheck, 200)
                    }
                    selectCheck(t) {
                    ...
                    _blur(t) {
                        ...
                        if (!0 === this.completeList[t.target.name]) {
                            ...
                            if (n && n[h]) {
                                for (i = 0; i < n[h].querySelectorAll(".-valid-item").length; i++) l = n[h].querySelectorAll(".-valid-item")[i].offsetHeight;
                                r.to(n[h], {
                                    duration: s.ANIM.speed,
                                    height: l,
                                    ease: s.ANIM.ease,
                    ...
                    _input(t) {
                        switch (t.target.type) {
                            ...
                            case "email":
                                ...
                                if (t.target.value.match(/^[A-Za-z0-9]{1}[A-Za-z0-9_.-]*@{1}[A-Za-z0-9_.-]{1,}\.[A-Za-z0-9]{1,}$/) ? this.completeList[t.target.name] = !0 : this.completeList[t.target.name] = !1, i && this.el.querySelectorAll(`input[name=${i}]`).length > 0) {
                                    const s = this.el.querySelectorAll(`input[name=${i}]`);
                                    for (var e = 0; e < s.length; e++) s[e].value !== t.target.value && (this.completeList[t.target.name] = !1)
                                }
                    ...
                    _check(t, e) {
                        ...
                        void 0 !== e || s || (!0 === t.target.checked ? t.target.classList.remove("is-err") : t.target.classList.add("is-err")), this._allcheck_()
                    }
                    _allcheck_() {
                        let t = !0;
                    ...
                    _addevents() {
                        for (var t = 0; t < this.items.tgt.length; t++) {
                            ...
                            switch (this.completeList[s.name] = !1, e) {
                                case "SELECT":
                                    s.addEventListener("change", this.onChange, !1), s.addEventListener("blur", this.onBlur, !1), this.selectCheck(s);
                                    break;
                                case "INPUT":
                                    switch (s.type) {
                                        case "checkbox":
                                        case "radio":
                                            s.addEventListener("change", this.onCheck, !1), this._check({
                                                target: s
                                            }, !0);
                                            break;
                                        default:
                                            s.addEventListener("input", this.onInput, !1), s.addEventListener("blur", this.onBlur, !1), s.addEventListener("blurDispatch", this.onBlur, !1), this._input({
                                                target: s
                                            }), "" !== s.value && this._blur({
                                                target: s
                                            })
                                    ...
                                    break;
                                case "TEXTAREA":
                                    s.addEventListener("input", this.onInput, !1), s.addEventListener("blur", this.onBlur, !1), this._input({
                                        target: s
                                    }), "" !== s.value && this._blur({
                                        target: s
                                    })
                        ...
                        for (t = 0; t < this.items.check.length; t++) {
                            ...
                            switch (this.completeList[s.name] = !0, e) {
                                ...
                                case "INPUT":
                                    ...
                                    break;
                                case "TEXTAREA":
                                    s.addEventListener("input", this.onInput, !1), s.addEventListener("blur", this.onBlur, !1), this._check({
                                        target: s
                                    })
                            }
                        }
                                ...
                                case "INPUT":
                                    switch (s.type) {
                                        ...
                                        case "radio":
                                            ...
                                            break;
                                        default:
                                            s.removeEventListener("input", this.onInput, !1), s.removeEventListener("blur", this.onBlur, !1), s.removeEventListener("blurDispatch", this.onBlur, !1)
                                    }
                                    break;
                                case "TEXTAREA":
            ...
            const Kt = new class {
                ...
                init() {
                    if (this.item = a.new.querySelectorAll("form"), this.select = a.new.querySelectorAll("select"), this.item.length > 0 && this.NOW !== this.FORMATTR)
                        for (var t = 0; t < this.DEF.length; t++) this.DEF[t].content = this.FORMATTR, this.NOW = this.FORMATTR;
            ...
            const Zt = class {
                constructor(t) {
                    this.el = t, this.USEHOVER = "click" === a.evt, this.STATE = !1, this.SCROLL = 0, this.EP = {
                        ...
                        w: 0,
                        h: 0
                    }, this.X = 0, this.Y = 0, this.TGT = {
                        f: 0,
                        t: 0
                    }, this.onMe = this._mouseEnter.bind(this), this.onMl = this._mouseLeave.bind(this), this.onUpdate = this._update.bind(this), this.item = {
                ...
                _attach() {
                    const t = this;
                    if (!0 === this.USEHOVER)
                        for (var e = 0; e < this.item.tgt.length; e++) this.item.tgt[e].setAttribute("data-cunt", e), this.item.tgt[e].addEventListener("mouseenter", this.onMe, !1), this.item.tgt[e].addEventListener("mouseleave", this.onMl, !1), c.on(u, t.onUpdate)
                }
                _mouseEnter(t) {
                    const e = this,
                        s = t.currentTarget;
                    ...
                    this.EP.x = h.left, this.EP.y = h.top, this.EP.w = h.width, this.EP.h = h.height, this.STATE = !0, r.killTweensOf(this.item.stg), r.to(this.item.stg, {
                        duration: e.anim.sh.speed,
                        opacity: 1,
                        ease: e.anim.sh.ease
                    }), r.killTweensOf([i, n]), r.to([i, n], {
                        duration: e.anim.speed,
                        xPercent: 0,
                        ease: e.anim.ease
                    })
                ...
                once() {
                    if (!0 === this.USEHOVER) this.el.classList.add("is-hover"), r.set(this.item.stg, {
                        ...
                        for (var t = 0; t < this.item.mv.length; t++) this.item.mv[t].play()
                }
                _addMovies() {
                    const t = [],
                    ...
                    if (null !== e)
                        for (s = 0; s < t.length; s++) e.appendChild(t[s]);
                ...
                _kill() {
                    if (!0 === this.USEHOVER)
                        for (var t = 0; t < this.item.tgt.length; t++) this.item.tgt[t].removeEventListener("mouseenter", this.onMe, !1), this.item.tgt[t].removeEventListener("mouseleave", this.onMl, !1);
                    return null
                }
            },
                Jt = {
                ...
                Qt = class {
                    constructor(t) {
                        this.el = t, this.HASH = $t("job"), this.HASITEM = !1, this.item = {
                            ...
                            delay: .4,
                            ease: "power2.inOut"
                        }, this.onSelect = this._select.bind(this), this.onChange = this._change.bind(this), this.onClick = this._click.bind(this), this.init()
                    }
                    init() {
                    ...
                    once() {
                        let t = 0;
                        if (void 0 !== this.HASH)
                            for (var e = 0; e < this.item.one.length; e++) this.HASH === this.item.one[e].id && (t = e, this.HASITEM = !0);
                        for (e = 0; e < this.item.one.length; e++) r.set(this.item.one[e], {
                            autoAlpha: e !== t ? 0 : 1,
                            pointerEvents: e !== t ? "none" : "inherit"
                        });
                        for (e = 0; e < this.item.select.length; e++) this.item.select[e].addEventListener("change", this.onSelect, !1);
                        for (e = 0; e < this.item.ipt.length; e++) this.item.ipt[e].addEventListener("change", this.onChange, !1);
                        for (e = 0; e < this.item.btn.length; e++) e === t && this.item.btn[e].classList.add("is-select"), this.item.btn[e].addEventListener("click", this.onClick, !1)
                    }
                    size() {
                        let t = 0;
                        for (var e = 0; e < this.item.one.length; e++) {
                    ...
                    _kill() {
                        for (var t = 0; t < this.item.select.length; t++) this.item.select[t].removeEventListener("change", this.onSelect, !1);
                        for (t = 0; t < this.item.ipt.length; t++) this.item.ipt[t].removeEventListener("change", this.onChange, !1)
                    }
                },
                te = new class {
                    constructor() {
                ...
                ee = ("undefined" == typeof window || window.ontouchstart, function (t) {
                    let e = !1;
                    try {
                        window.addEventListener("test", null, Object.defineProperty({}, "passive", {
                            get: function () {
                ...
                oe = class {
                    constructor(t) {
                        this.el = t, this.WPEL = a.new.querySelector(".scroll-content"), this.items = {
                            ...
                            viewport: 0,
                            option: null
                        }, this.onBtn = this._btn.bind(this), this.onStart = this._start.bind(this), this.onMove = this._move.bind(this), this.onEnd = this._end.bind(this), this.onLink = this._link.bind(this), this.onLinkMove = this._linkMove.bind(this), this.onLinkDown = this._linkDown.bind(this), this.onKeyDown = this._keyDown.bind(this), this.onDot = this._dot.bind(this), this.init()
                    }
                    init() {
                    ...
                    getSize() {
                        ...
                        this.items.list.length > 0 && (e += this.items.list[0].offsetWidth, this.config.allval = this.items.list[0].offsetWidth), this.config.amount = e, this.items.one.length > 1 ? this.config.win = this.items.one[1].getBoundingClientRect().left - this.items.one[0].getBoundingClientRect().left : this.config.win = this.config.viewport;
                    ...
                    _check() {
                        const t = a.vw >= 1e3 ? .01 : .02,
                            e = Math.max(Math.min(Math.round((this.values.c.x + this.values.p.x * t * this.config.win) / this.config.win), this.config.all - 1), 0);
                        ...
                        if ("opacity" === this.config.option)
                            for (i = 0; i < this.postinos.length; i++) {
                                const t = this.postinos[i].i,
                                    e = Math.round(100 * (this.values.c.x <= this.postinos[i].l ? 1 - (this.postinos[i].l - this.values.c.x) / this.config.win : this.values.c.x > this.postinos[i].l ? (this.postinos[i].l - this.values.c.x) / this.config.win + 1 : 0)) / 100;
                    ...
                    _attach() {
                        ...
                        this.el.addEventListener(ie.start, this.onStart, ie.passivetrue), this.WPEL.addEventListener(ie.move, this.onMove, ie.passivefalse), this.WPEL.addEventListener(ie.end, this.onEnd, ie.passivetrue);
                        for (t = 0; t < this.items.btn.length; t++) this.items.btn[t].addEventListener("click", this.onBtn, !1);
                        if (this.config.hasDots)
                    ...
                    _updateCircu() {
                        r.set(this.hover.ico, {
                            clipPath: `circle(${this.hvalue.prog}%)`
                        })
                    }
                    _kill() {
                        ...
                        if (this.postinos.length = 0, this.el.removeEventListener(ie.start, this.onStart, ie.passivetrue), this.WPEL.removeEventListener(ie.move, this.onMove, ie.passivefalse), this.WPEL.removeEventListener(ie.end, this.onEnd, ie.passivetrue), "mousedown" === ie.start) {
                            for (t = 0; t < this.items.link.length; t++) this.items.link[t].removeEventListener("click", this.onLink, !1), this.items.link[t].removeEventListener(ie.start, this.onLinkDown, ie.passivefalse), this.items.link[t].removeEventListener(ie.move, this.onLinkMove, ie.passivefalse);
                            document.removeEventListener("keydown", this.onKeyDown, !1)
                        }
                        for (t = 0; t < this.items.btn.length; t++) this.items.btn[t].removeEventListener("click", this.onBtn, !1);
                        if (this.config.hasDots)
                            for (t = 0; t < this.items.dot.length; t++) this.items.dot[t].removeEventListener("click", this.onDot, !1)
                    }
                },
                re = {
                    conf: [],
                ...
                ae = class {
                    ...
                    _default(t, e) {
                        for (var s = 0; s < t.length; s++) t[s].isIntersecting ? (this.el.classList.add("is-rdrg"), this.inf.play()) : (this.el.classList.remove("is-rdrg"), this.inf.pause())
                    }
                    _kill() {
                ...
                le = class {
                    constructor(t) {
                        ...
                        }), this.clone = [], this.clonewp = [], this.item = {
                            tgt: t.querySelectorAll(".js-rpt-ln"),
                ...
                ue = class {
                    ...
                    render() {
                        ...
                        r.mapTypes.set("株式会社Spade&Co.", l), r.setMapTypeId("株式会社Spade&Co."), google.maps.event.addListener(h, "click", (function () {
                ...
                de = new class {
                    ...
                    init() {
                        ...
                        }, this.SITEPARTS = h.body.querySelectorAll(".-siteparts"), this.onHover = t._hoverCard.bind(this), this.onClose = t._close.bind(this), this.onHit = t._hitCard.bind(this), this.onGetSize = t._getSize.bind(this), this.onGetState = t._getState.bind(this), this.onToPivot = this._scrollToPivot.bind(this), this.onEnter = this.enter.bind(this), this.onLeave = this.leave.bind(this), this.once(), this._attach(), this.ALIVE = !0)
                    }
                    once() {
                    ...
                    _attach() {
                        for (var t = 0; t < this.item.close.length; t++) this.item.close[t].addEventListener("click", this.onClose, !1), "is-pc" === a.act && (this.item.close[t].addEventListener("mouseenter", this.onEnter, !1), this.item.close[t].addEventListener("mouseleave", this.onLeave, !1));
                    ...
                    _open() {
                        ...
                        if (null !== this.CURRENT) {
                            ...
                            document.body.style.cursor = null, this.item.wp.classList.add("is-open"), this.item.one[this.CURRENT].classList.add("is-current"), r.to(this.SITEPARTS, {
                                duration: t.anim.wp.speed,
                                autoAlpha: 0,
                                ease: t.anim.wp.ease
                            }), r.killTweensOf(s), r.set(s, {
                                y: 30,
                                opacity: 0
                            }), r.to(this.item.wp, {
                                duration: t.anim.wp.speed,
                            ...
                            for (var e = 0; e < s.length; e++) r.to(s[e], {
                    ...
                    _close() {
                        ...
                        if (!0 === this.enableClose && null !== this.CURRENT) {
                            ...
                            this.item.wp.classList.remove("is-open"), this.item.one[this.CURRENT].classList.remove("is-current"), r.to(this.SITEPARTS, {
                                ...
                                autoAlpha: 1,
                                ease: t.anim.wp.ease
                            }), c.emit("CLOSE_WORK_CARD"), r.to(this.item.wp, {
                                duration: t.anim.wp.speed,
                                autoAlpha: 0,
                                ease: t.anim.wp.ease
                            }), this.leave();
                            for (var e = 0; e < s.length; e++) r.killTweensOf(s[e]), r.to(s[e], {
                                duration: t.anim.item.speed,
                                y: -30,
                                opacity: 0,
                    ...
                    _scrollToPivot(t) {
                        ...
                        this.DELAY = e.duration, null !== gt.smoothScroll && gt.smoothScroll.scrollTo(0, e.targetScroll, 100 * e.duration)
                    }
                    _getSize(t) {
                        let {
                            detail: e
                    ...
                    enter() {
                        r.to(this.item.btn, {
                            duration: this.anim.wp.speed,
                            opacity: 1,
                            ease: this.anim.wp.ease
                        })
                    }
                    leave() {
                        r.to(this.item.btn, {
                    ...
                    _kill() {
                        if (this.CURRENT = 0, document.body.style.cursor = null, this._close(), !0 === this.ALIVE)
                            for (var t = 0; t < this.item.close.length; t++) this.item.close[t].removeEventListener("click", this.onClose, !1);
                ...
                pe = class {
                    constructor(t) {
                        this.el = t, this.item = {
                            ...
                            open: !1,
                            num: Number(t.getAttribute("data-contents")) < this.item.one.length ? Number(t.getAttribute("data-contents")) : this.item.one.length
                        }, this.conf.num >= this.item.one.length && (this.conf.open = !0), this.anim = {
                            speed: .8,
                            ease: "power2.inOut"
                        }, this.onOpen = this.open.bind(this), this.init()
                    }
                    init() {
                        this.once(), this.size()
                    }
                    once() {
                        for (var t = 0; t < this.item.btn.length; t++) this.item.btn[t].addEventListener("click", this.onOpen, !1);
                    ...
                    _kill() {
                        for (var t = 0; t < this.item.btn.length; t++) this.item.btn[t].removeEventListener("click", this.onOpen, !1)
                    }
                },
                ve = new class {
                    constructor() {
                ...
                fe = class {
                    constructor(t) {
                        this.el = t, this.SCROLL = null, this.ARR = null, this.ALL = 0, this.MOVE = !1, this.ENTER = !1, this.SIZE = {
                            ...
                            from: 0,
                            to: 0
                        }, this.IM = [], this.CACHE = 0, this.item = {
                        ...
                        }, this.SITEPARTS = h.body.querySelectorAll(".-siteparts"), this.onHover = this._hoverBtn.bind(this), this.onLeave = this._leave.bind(this), this.onOpen = this._open.bind(this), this.onClose = this._close.bind(this), this.onBtn = this._btn.bind(this), this.onUpdate = this._update.bind(this), this.onStart = this._start.bind(this), this.onMove = this._move.bind(this), this.onEnd = this._end.bind(this), this.init()
                    }
                    init() {
                        this.once(), this._attach(), this._getSize()
                    }
                    once() {
                        ...
                        if ("is-pc" === a.act)
                            for (t = 0; t < this.item.arr.length; t++) this.item.arr[t].style.opacity = 0
                    }
                    _start(t) {
                        t.currentTarget;
                    ...
                    _check() {
                        const t = a.vw >= 1e3 ? .01 : .02,
                            e = Math.max(Math.min(Math.round((this.values.c.x + this.values.p.x * t * this.SIZE.one) / this.SIZE.one), this.ALL - 1), 0);
                    ...
                    engine() {
                        ...
                        if (this.CONFIG.from = this.CONFIG.to, this.CONFIG.to = this.state.current, this._btncheck(), this.CONFIG.from === this.CONFIG.to) return;
                        ...
                        }), !0 === this.MOVE && (r.killTweensOf(this.values.m), r.to(t.values.m, {
                            duration: t.anim.item.speed,
                        ...
                        })), r.killTweensOf(this.item.cre[i]), r.to(this.item.cre[i], {
                            duration: t.anim.item.speed,
                            opacity: 1,
                            delay: n + t.anim.item.speed,
                            ease: t.anim.item.ease
                        }), r.killTweensOf(this.item.cre[s]), r.to(this.item.cre[s], {
                            duration: t.anim.item.speed,
                            opacity: 0,
                            delay: n,
                            ease: t.anim.item.ease,
                    ...
                    _btncheck() {
                        for (var t = 0; t < this.item.btn.length; t++) "p" === this.item.btn[t].getAttribute("data-dir") && (this.CONFIG.to <= 0 ? this.item.btn[t].classList.add("is-hidden") : this.item.btn[t].classList.remove("is-hidden")), "n" === this.item.btn[t].getAttribute("data-dir") && (this.CONFIG.to >= this.ALL - 1 ? this.item.btn[t].classList.add("is-hidden") : this.item.btn[t].classList.remove("is-hidden"))
                    }
                    _creditManagement() {
                        let t = 0;
                        for (var e = 0; e < this.item.cre.length; e++) this.item.cre[e].style.display = e === this.CONFIG.to ? "block" : "none", this.item.cre[e].style.opacity = e === this.CONFIG.to ? 1 : 0, e === this.CONFIG.to && (t = this.item.cre[e].offsetHeight);
                    ...
                    _getSize() {
                        ...
                        for (var t = 0; t < this.item.sl.length; t++) this.SIZE.win = this.item.sl[t].getBoundingClientRect().width, this.SIZE.one = this.SIZE.win;
                        ...
                        if (!0 === this.OPEN) {
                            ...
                            for (var t = 0; t < this.IM.length; t++) {
                                const e = this.WIN.max + this.SIZE.win - this.IM[t].s,
                                    ...
                                    o = this.values.c.x < this.IM[t].s ? 1 + (this.values.c.x - this.IM[t].s) / this.IM[t].w : 1 - (this.values.c.x - this.IM[t].s) / this.IM[t].w,
                    ...
                    _hoverBtn(t) {
                        ...
                        r.killTweensOf(s), r.to(s, {
                            duration: this.anim.icon.speed,
                            opacity: 1,
                            ease: this.anim.icon.ease
                        })
                    }
                    _leave(t) {
                    ...
                    _attach() {
                        for (var t = 0; t < this.item.slw.length; t++) this.item.slw[t].addEventListener(ie.start, this.onStart, ie.passivetrue);
                        window.addEventListener(ie.move, this.onMove, ie.passivefalse), window.addEventListener(ie.end, this.onEnd, ie.passivetrue);
                        for (t = 0; t < this.item.hit.length; t++) this.item.hit[t].setAttribute("data-un", t), this.item.hit[t].addEventListener("click", this.onOpen, !1);
                        for (t = 0; t < this.item.close.length; t++) this.item.close[t].addEventListener("click", this.onClose, !1);
                        for (t = 0; t < this.item.btn.length; t++) this.item.btn[t].addEventListener("click", this.onBtn, !1), "is-pc" === a.act && (this.item.btn[t].addEventListener("mouseenter", this.onHover, !1), this.item.btn[t].addEventListener("mouseleave", this.onLeave, !1));
                        this.item.win.length > 0 && (this.SCROLL = pt.Z.init(this.item.win[0]))
                    }
                    _kill() {
                        this._close();
                        for (var t = 0; t < this.item.slw.length; t++) this.item.slw[t].removeEventListener(ie.start, this.onStart, ie.passivetrue);
                        ...
                        for (t = 0; t < this.item.close.length; t++) this.item.close[t].removeEventListener("click", this.onClose, !1);
                        for (t = 0; t < this.item.btn.length; t++) this.item.btn[t].removeEventListener("click", this.onBtn, !1), "is-pc" === a.act && (this.item.btn[t].removeEventListener("mouseenter", this.onHover, !1), this.item.btn[t].removeEventListener("mouseleave", this.onLeave, !1));
                ...
                we = new class {
                    ...
                    init() {
                        ...
                        }), Y.init(), g.init(), R.init(), this.firstView = new Z, this.about = new Q, this.aboutVideos = new st, this.camera = new F.c(45, v.dimensions.x / v.dimensions.y, .1, 1e5), this.camera.position.set(0, 0, 1e3), this.camera.lookAt(this.scene.position), this.ourWork = new dt(this.camera), this.scene.add(this.firstView.group), this.scene.add(this.about.group), this.scene.add(this.aboutVideos.group), this.scene.add(this.ourWork.group), this.scene.add(this.ourWork.workLoopText.group), this.fadeTL = null, this.scene.background = R.fbo_output.texture, "index" !== this.firstPage && (this.scene.visible = !1, g.params.opacity = 0);
                        let t = !1,
                            e = !1;
                        c.on("FINISH_LOADING", (() => {
                            setTimeout((() => {
                        ...
                        }), 2e3), c.on("LEAVE_INDEX", (() => {
                            this.fadeTL && this.fadeTL.kill(), this.fadeTL = n.ZP.timeline({
                                onComplete: () => {
                                    this.scene.visible = !1
                                }
                            }), L("isIndex", !1), this.ourWork.removeEvent(), this.firstView.hideVideos(), this.firstView.hide(), this.aboutVideos.hideVideo(), this.fadeTL.to(g.params, .5, {
                                opacity: 0
                            })
                        })), c.on("ENTER_INDEX", (() => {
                ...
                Se = function () {
                    _e.Z.init({
                        ...
                        transitions: [{
                            ...
                            sync: !1,
                            leave: t => r.to(t.current.container, {
                                duration: be,
                                opacity: 0,
                                ease: Te,
                                onStart: function () {
                        ...
                        requestError: (t, e, s, i) => ("click" === e && i.status && 404 === i.status && s && (location.href = s), !1)
            ...
            l.init(), Ee.length <= 0 && "entry" !== h.getElementById("js-ct").getAttribute("data-pj-dir") && Se(), xe.once(), xe.init(), Ft.init(), a.resize = Le, window.addEventListener("resize", Le, !1), r.ticker.add((function () {
                xe._update()
            }))
        },
        7062: () => {
    ...
    i.m = e, t = [], i.O = (e, s, n, o) => {
        if (!s) {
            ...
            for (c = 0; c < t.length; c++) {
                for (var [s, n, o] = t[c], a = !0, h = 0; h < s.length; h++)(!1 & o || r >= o) && Object.keys(i.O).every((t => i.O[t](s[h]))) ? s.splice(h--, 1) : (a = !1, o < r && (r = o));
                if (a) {
                    t.splice(c--, 1);
                    var l = n();
                    void 0 !== l && (e = l)
